...
class TeacherLog extends Frame implements ActionListener, WindowListener{
	...
	public TeacherLog(SmsPage1 f){
		super("Student Management System, Teacher Log In");
		p1=f;
	...
	public void actionPerformed(ActionEvent e){
		...
		if(s.equals("Login"))
		{
			...
			String q="select tId, tPassword from teacher";
			ResultSet rs=null;	
			try{
				rs=da.getData(q);
				while(rs.next()){
					String un = rs.getString("tId");
					String tp= rs.getString("tPassword");
